...
func (m *MockBastionScope) LoadBalancerName() string {
	m.ctrl.T.Helper()
...
func (mr *MockBastionScopeMockRecorder) LoadBalancerName() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "LoadBalancerName", reflect.TypeOf((*MockBastionScope)(nil).LoadBalancerName))
}

// Network mocks base method.
func (m *MockBastionScope) Network() *v1alpha3.Network {
	m.ctrl.T.Helper()
...
func (mr *MockBastionScopeMockRecorder) Network() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Network", reflect.TypeOf((*MockBastionScope)(nil).Network))
}
